...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->åäàtoolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::åäàtoolStripMenuItem_Click);
			// 
			...
			this->infosatietylabel->Text = L"Ñûòîñòü";
			// 
			// infomoneybalance
			// 
			...
			this->buysuitbutton->Text = L"Êóïèòü êîñòþì(5000$)";
			...
			this->threebutton->Text = L"Ðåñòîðàí  (100$)";
			...
			this->twofoodbutton->Text = L"Êàôå (20$)";
			...
			this->onefoodbutton->Text = L"Ôàñò-Ôóä (5$)";
			...
			this->labelsatiety->Text = L"Ñûòîñòü:";
			// 
			// foodlabel
			// 
...
#pragma endregion
	...
	private: System::Void åäàtoolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
