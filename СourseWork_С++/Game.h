...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->едаtoolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menu->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->работаToolStripMenuItem,
					this->имуществоToolStripMenuItem, this->персонажToolStripMenuItem, this->здоровьеToolStripMenuItem, this->едаtoolStripMenuItem,
			...
			// 
			this->работаToolStripMenuItem->AutoSize = false;
			this->работаToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 14));
			this->работаToolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"работаToolStripMenuItem.Image")));
			this->работаToolStripMenuItem->Name = L"работаToolStripMenuItem";
			this->работаToolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->работаToolStripMenuItem->Text = L"Работа";
			this->работаToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->работаToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->работаToolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::работаToolStripMenuItem_Click);
			// 
			// имуществоToolStripMenuItem
			// 
			this->имуществоToolStripMenuItem->AutoSize = false;
			this->имуществоToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 14));
			this->имуществоToolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"имуществоToolStripMenuItem.Image")));
			this->имуществоToolStripMenuItem->Name = L"имуществоToolStripMenuItem";
			this->имуществоToolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->имуществоToolStripMenuItem->Text = L"Имущество";
			this->имуществоToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->имуществоToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->имуществоToolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::имуществоToolStripMenuItem_Click);
			// 
			// персонажToolStripMenuItem
			// 
			this->персонажToolStripMenuItem->AutoSize = false;
			this->персонажToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 14));
			this->персонажToolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"персонажToolStripMenuItem.Image")));
			this->персонажToolStripMenuItem->Name = L"персонажToolStripMenuItem";
			this->персонажToolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->персонажToolStripMenuItem->Text = L"Персонаж";
			this->персонажToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->персонажToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->персонажToolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::персонажToolStripMenuItem_Click);
			// 
			// здоровьеToolStripMenuItem
			// 
			this->здоровьеToolStripMenuItem->AutoSize = false;
			this->здоровьеToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 14));
			this->здоровьеToolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"здоровьеToolStripMenuItem.Image")));
			this->здоровьеToolStripMenuItem->Name = L"здоровьеToolStripMenuItem";
			this->здоровьеToolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->здоровьеToolStripMenuItem->Text = L"Здоровье";
			this->здоровьеToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->здоровьеToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->здоровьеToolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::здоровьеToolStripMenuItem_Click);
			// 
			// едаtoolStripMenuItem
			// 
			this->едаtoolStripMenuItem->AutoSize = false;
			this->едаtoolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"едаtoolStripMenuItem.Image")));
			this->едаtoolStripMenuItem->Name = L"едаtoolStripMenuItem";
			this->едаtoolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->едаtoolStripMenuItem->Text = L"Еда";
			this->едаtoolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->едаtoolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->едаtoolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::едаtoolStripMenuItem_Click);
			// 
			// одеждаToolStripMenuItem
			// 
			this->одеждаToolStripMenuItem->AutoSize = false;
			this->одеждаToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 14));
			this->одеждаToolStripMenuItem->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"одеждаToolStripMenuItem.Image")));
			this->одеждаToolStripMenuItem->Name = L"одеждаToolStripMenuItem";
			this->одеждаToolStripMenuItem->Size = System::Drawing::Size(120, 76);
			this->одеждаToolStripMenuItem->Text = L"Одежда";
			this->одеждаToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::BottomCenter;
			this->одеждаToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->одеждаToolStripMenuItem->Click += gcnew System::EventHandler(this, &Game::одеждаToolStripMenuItem_Click);
			// 
			// Infobox
			// 
			...
			this->infosatietylabel->Text = L"Сытость";
			// 
			// infomoneybalance
			// 
			...
			this->infohealth->Text = L"Здоровье";
			// 
			// infoname
			// 
			...
			this->humanbalance->Text = L"БАЛАНС";
			...
			this->labelhumanbalance->Text = L"Баланс";
			// 
			// humanage
			// 
			...
			this->labelhumanage->Text = L"Возраст";
			// 
			// humansex
			// 
			...
			this->labelhumanname->Text = L"Имя";
			// 
			// labelmyhuman
			// 
			...
			this->labelmyhuman->Text = L"Мой персонаж";
			// 
			// groupBoxworker
			// 
			...
			this->labelpayment->Text = L"Оплата";
			// 
			// Namework
			// 
			...
			this->labelNamework->Text = L"Работа";
			// 
			// workername
			// 
			...
			this->labelworkerhumanname->Text = L"Имя";
			// 
			// labelworker
			// 
			...
			this->labelworker->Text = L"Рабочая карточка";
			// 
			// groupBoxmd
			// 
			...
			this->labelhealth->Text = L"Здоровье";
			// 
			// imt
			// 
			...
			this->labelmdheight->Text = L"Рост";
			// 
			// mdweight
			// 
			...
			this->buysuitbutton->Text = L"Купить костюм(5000$)";
			...
			this->threebutton->Text = L"Ресторан  (100$)";
			...
			this->twofoodbutton->Text = L"Кафе (20$)";
			...
			this->onefoodbutton->Text = L"Фаст-Фуд (5$)";
			...
			this->labelsatiety->Text = L"Сытость:";
			// 
			// foodlabel
			// 
			...
			this->checkBoxcar->Text = L"Транспорт";
			...
			this->checkBoxhouse->Text = L"Жильё";
			...
			this->labelrealtybuy->Text = L"Купить новое";
			// 
			// realtycar
			// 
			...
			this->realtycar->Text = L"АВТОМОБИЛЬ";
			...
			this->labelrealtycar->Text = L"Транспорт";
			// 
			// realtyhouse
			// 
			...
			this->labelrealtyhouse->Text = L"Жильё";
			// 
			// labelrealty
			// 
			...
			this->autoeatbutton->Text = L"Антиголод";
			...
			this->autohealthbutton->Text = L"Автолечение";
			...
			this->autosewupbutton->Text = L"Автопочинка одежды";
			...
			this->boostersbutton->Text = L"Бустеры";
